...
const DiscoverMoreSlider = () => {
  ...
  return (
    ...
    >
      ...
      <Heading
        className="mt-5 mb-5 lg:mb-5 text-neutral-900 dark:text-neutral-50 nc-p-r-container "
        desc=""
        rightDescText="" //sample test right of "Discover more" is at the bottom in heading tag
        hasNextPrev
      >
        <div></div>
      </Heading>
